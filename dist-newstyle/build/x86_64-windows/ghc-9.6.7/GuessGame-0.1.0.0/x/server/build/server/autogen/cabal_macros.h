...
/* package GuessGame-0.1.0.0 */
#ifndef VERSION_GuessGame
#define VERSION_GuessGame "0.1.0.0"
#endif /* VERSION_GuessGame */
#ifndef MIN_VERSION_GuessGame
#define MIN_VERSION_GuessGame(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_GuessGame */
...
#define CURRENT_COMPONENT_ID "GuessGame-0.1.0.0-inplace-server"
